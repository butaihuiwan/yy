...
value = WebUI.getText(findTestObject('Person/MyAccount/AssetDeatails/assettotal'))
...
WebUI.click(findTestObject('Mechainism/MyAccount/Myasset/Pane-1'))

value1 = WebUI.getText(findTestObject('Mechainism/MyAccount/Myasset/Pane-1-value'))
...
WebUI.click(findTestObject('Mechainism/MyAccount/Myasset/Pane-2'))

value1 = WebUI.getText(findTestObject('Mechainism/MyAccount/Myasset/Pane-2-value'))
