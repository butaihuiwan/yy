...
CustomKeywords.'time.Timesleep.timesleep'(3)

WebUI.click(findTestObject('Person/MyAccount/TradeRecord/TradeApply/TradeApply'))

value = WebUI.getText(findTestObject('Mechainism/Matters/Trade/TradeApplylist'))
